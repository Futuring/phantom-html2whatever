...
var fs = require("fs"),
	tmp = require("tmp"),
	debug = require('debug')('phantom-html2whatever');

var method = FileResult.prototype;

function FileResult(err, tmpPath, deleteOnAction) {
    this._err = err;
...
method.toStream = function() {
	if (this._invalid) throw new Error('FileResult became invalid after deletion!');
